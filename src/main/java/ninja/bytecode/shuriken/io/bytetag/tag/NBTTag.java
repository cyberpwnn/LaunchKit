 ...
 * If an instance is nested further than allowed, a {@link NBTRawMaxDepthReachedException} will be thrown.
 ...
 * */
public abstract class NBTTag<T> implements Cloneable {
	...
	/**
	 * Calls {@link NBTTag#toString(int)} with an initial depth of {@code 0}.
	 * @see NBTTag#toString(int)
	 * @throws NBTRawMaxDepthReachedException If the maximum nesting depth is exceeded.
	 * */
	@Override
	...
	/**
	 * Calls {@link NBTTag#valueToString(int)} with {@link NBTTag#DEFAULT_MAX_DEPTH}.
	...
	/**
	 * Calculates the hash code of this Tag. Tags which are equal according to {@link NBTTag#equals(Object)}
	 ...
	 * or to create the JSON string representation of a Tag returned from {@link NBTTag#toString()}
